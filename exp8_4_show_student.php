...
<head>
    ...
    <title>exp8_4_studentList</title>
    <style type="text/css">
        * {
            margin: 0;
            padding: 0px;
...
<body>
    <div id="main">
        <table>
            <form action="exp8_4_students_del.php" method="post">
                <tr>
                    <th>删除</th>
                    <th>序号</th>
                    <th>学号</th>
        ...
        <p style="margin-top:30px"><a href="exp8_4.html">返回输入界面</a>
        ...
        <div class="formcls">
            <form action="#" method="GET">
                ...
                echo '<a href="exp8_4_show_student.php?page=', $pre, '">前一页</a>';
                printf("<a href=\"exp8_4_show_student.php?page=%d\">后一页</a>", $next);
                ?>
            </form>
        </div>
    </div>
