...
<div id="main" class="auto">
    <div id="left">
        <div class="box_wrap">
            ...
            <div class="num">
                <?php
                $query = "select count(*) from sfk_son_module,sfk_content where sfk_content.module_id=sfk_son_module.id and sfk_son_module.id={$_GET['id']}";
                $count_all = num($link,$query);
                $query = "select count(*) from sfk_son_module,sfk_content where sfk_content.module_id=sfk_son_module.id and sfk_son_module.id={$_GET['id']} and sfk_content.time > current_date";
                $count_today = num($link,$query);

                $query = "select * from sfk_member,sfk_son_module where sfk_son_module.id={$_GET['id']}";
            ...
            <div class="notice">简介：<span><?php echo $son_data['info']?></span></div>
            <div class="pages_wrap">
                <a class="btn publish" target="_blank" href="publish.php?id=<?php echo $_GET['id']?>"></a>
                <div class="pages">
                    <?php
        ...
        <ul class="postsList">
            <?php
            $query = "select sfk_content.title,sfk_content.id,sfk_member.name,sfk_content.time,sfk_content.times,sfk_content.module_id,sfk_member.photo,sfk_son_module.module_name from sfk_member,sfk_content,sfk_son_module where sfk_content.member_id=sfk_member.id and sfk_content.module_id={$_GET['id']} and sfk_son_module.id=sfk_content.module_id {$page['limit']}";
            ...
            while ($data_content = mysqli_fetch_assoc($result_content)){
                ...
                <li>
                    ...
                    <div class="subject">
                        <div class="titleWrap"><a href="list_son.php?id=<?php echo $data_content['module_id']?>">[<?php echo $data_content['module_name']?>]</a>&emsp;
                        <h2 ><a href="show.php?id=<?php echo $data_content['id']?>"><?php echo $data_content['title']?></a></h2></div>
                        <p>
