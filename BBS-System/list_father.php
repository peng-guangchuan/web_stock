...
<div id="main" class="auto">
    <div id="left">
        <div class="box_wrap">
            ...
            <div class="num">
                今日：<span><?php echo $data_count_today[0];?></span>&emsp;&emsp;
    ...
    ?>
            <li>
                ...
                <div class="subject">
                    ...
                    <p>
                        楼主：<?php echo $data_content['name']?>&emsp;&emsp;&emsp;&emsp;
                        <?php echo $data_content['time']?>&emsp;&emsp;&emsp;
                        最后回复：<?php echo $data_last['time']?>
                    </p>
                </div>
                <div class="count">
                    <p>
